    ...
    app.send(idAplicativo, function (mailEnvio) {
        mailEnvio['mail'].sendMail({
            ...
            html:
                ...
                '<tr> ' +
                '<td bgcolor="#161615" align="center" valign="top" style="text-align: center; background-position: center center !important; background-size: cover !important;">' +
                '<div>' +
    ...
    app.send(idAplicativo, function (mailEnvio) {
        mailEnvio['mail'].sendMail({
            ...
            html:
                ...
                '<table role="presentation" align="center" cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" style="text-align: center;">' +
                '<tr>' +
                '<td style="border-radius: 50px; background: #161615; text-align: center;" class="button-td">' +
                '</td>' +
                '</tr>' +
                '</table>' +
                '</center>' +
